...
public class SumMethodCallTranslatorTests
{
    ...
    public void TranslateMethodCall_WithoutSelector_ShouldAppendReduce()
    {
        ...
        var method = typeof(System.Linq.Enumerable).GetMethods().First(e => e.Name == nameof(System.Linq.Enumerable.Sum));
    ...
    public void TranslateMethodCall_WithSelector_ShouldAppendMapAndReduce()
    {
        // Arrange
        var sb = new StringBuilder();
        var method = typeof(System.Linq.Enumerable).GetMethods().First(e => e.Name == nameof(System.Linq.Enumerable.Sum) && e.IsGenericMethodDefinition)!
