...
public class OnesComplementUnaryTranslatorTests
{
    [Fact]
    public void SupportedUnaries_ShouldNotContainNull()
    {
        // Arrange
        var supportedUnaries = OnesComplementUnaryTranslator.SupportedUnaries;
    ...
    public void TranslateBinary_AppendsLength()
    {
        ...
        var expression = Expression.OnesComplement(Expression.Parameter(typeof(int)));
        ...
        // Act
        OnesComplementUnaryTranslator.TranslateUnary(builder, expression, processNext);
