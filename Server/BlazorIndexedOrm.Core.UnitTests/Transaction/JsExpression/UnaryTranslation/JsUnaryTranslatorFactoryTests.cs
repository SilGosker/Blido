using BlazorIndexedOrm.Core.UnitTests.Mock.Transaction.JsExpression.BinaryTranslation;
using BlazorIndexedOrm.Core.UnitTests.Mock.Transaction.JsExpression.UnaryTranslation;
